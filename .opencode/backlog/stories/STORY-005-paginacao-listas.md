...
## Critérios de Aceite
- [x] `restore_client_ui`: clientes deletados paginados (10/page)
- [x] `list_client_servicos_ui`: serviços paginados (10/page)
- [x] `resumo_financeiro_ui`: clientes no resumo paginados (10/page)
- [x] Indicador "Página X de Y" visível em cada página
- [x] Funciona corretamente com 0 itens (mensagem amigável)
- [x] Funciona corretamente com menos de 10 itens (uma página só)
- [x] Testes unitários para a lógica de paginação
