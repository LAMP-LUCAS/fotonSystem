...
|----|-----------|------------|----------|--------|
| [STORY-020](stories/STORY-020-telemetria-session-operation-tracking.md) | Telemetria — Session + Operation Tracking | 5h | TELEMETRY-1.1, 1.2, 1.3, 1.4 | ready |
| [STORY-021](stories/STORY-021-nps-evolutivo-export-unificado.md) | NPS Evolutivo + Export Unificado | 4h | UX-9.1, UX-9.2, TELEMETRY-1.5 | ready |
| | **Total** | **9h** | **7 RULE-IDs** | |
...
- [ ] Atualizar AGENTS.md se novas ferramentas MCP forem adicionadas
