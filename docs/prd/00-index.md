...
- `docs/prd/epics/` — Épicos individuais (EPIC-001, EPIC-002, etc.)
- `docs/prd/00-index.md` — Este arquivo, serve como sumário e ponto de entrada
...
| EPIC-002 | Domínio, CRUD e Evolução da Experiência do Usuário | 2026-06-25 | active |
